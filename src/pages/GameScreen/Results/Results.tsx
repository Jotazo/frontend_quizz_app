...
const Results = () => {
  ...
  return (
    <PageContainer>
      {" "}
      <h1 className="sm:max-w-[85%] lg:max-w-none lg:w-[520px] text-[40px] sm:text-7xl lg:text-6xl leading-tight text-darkBlue dark:text-white">
        Quiz completed{" "}
        <span className="font-[RubikMedium] font-bold">You scored...</span>
      </h1>
      <section className="flex-1">
        <section className="flex flex-col items-center bg-white dark:bg-darkBlueLight sm:gap-10 py-6 sm:py-12 mt-8 sm:mt-14 lg:mt-0 mb-4 sm:mb-8 rounded-xl sm:rounded-3xl">
